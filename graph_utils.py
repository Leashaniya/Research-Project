...
# OPENAI CONFIG (keep for graph enrichment only)
openai.api_key = "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"
...
# GRAPH BUILDER
def build_pyvis_graph(lecture_data, mcq_data, sims, output_html, threshold=0.3):
    from pyvis.network import Network
    import webbrowser
