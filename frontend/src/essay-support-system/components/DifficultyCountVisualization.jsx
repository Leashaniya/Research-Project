...
export default function DifficultyCountVisualization({ session }) {
  ...
  return (
    <div className="difficulty-count-container">
      <div className="difficulty-count-header">
        <h3>Question Distribution by Difficulty</h3>
        <p>Track your practice across different difficulty levels</p>
      </div>
      ...
      <style>{`
        ...
        .difficulty-count-header {
          margin-bottom: 2rem;
        }

        .difficulty-count-header h3 {
          margin: 0 0 0.5rem 0;
          font-size: 1.5rem;
          font-weight: 700;
          color: #1f2937;
