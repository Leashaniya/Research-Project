...
def graph_view():
    ...
    # Check if graph exists in outputs folder
    graph_path = os.path.join('outputs', os.path.basename(OUTPUT_HTML))
    
    if os.path.exists(graph_path):
        return render_template('graph_view.html', graph_path=graph_path)
    else:
